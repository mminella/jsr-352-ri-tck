 ...
 * a single point of control running on the parent thread. The PartitionAnalyzer
...
public interface PartitionCollector {
	 ...
	 * processing a partition as follows:
	 * <p>
	 * <ol>
	 * <li>for a chunk type step, it receives control after every chunk
	 * checkpoint and then one last time at the end of the partition;</li>
	 * <li>for a batchlet type step, it receives control once at the end of the
	 * batchlet.</li>
	 * </ol>
	 * 
	 * @return
